...
const BASE_BUSINESS = {
  ...
  '@id': 'https://ultraroofingtx.net/#business',
  name: 'Ultra Roofing LLC',
  image: 'https://ultraroofingtx.net/ULTRA%20ROOFING%20transparent%20logo.png',
  url: 'https://ultraroofingtx.net',
...
function serviceSchema() {
  return {
    ...
    provider: { '@type': 'RoofingContractor', '@id': 'https://ultraroofingtx.net/#business', name: 'Ultra Roofing', telephone: '+18333567233', url: 'https://ultraroofingtx.net' },
...
function citySchema(cityName: string, citySlug: string) {
  return {
    '@context': 'https://schema.org',
    '@type': 'RoofingContractor',
    '@id': `https://ultraroofingtx.net/service-areas/${citySlug}/#business`,
    name: 'Ultra Roofing',
    image: 'https://ultraroofingtx.net/ULTRA%20ROOFING%20transparent%20logo.png',
    url: `https://ultraroofingtx.net/service-areas/${citySlug}`,
    telephone: '+18333567233',
    email: 'office@ultraroofingtx.com',
    priceRange: '$$',
