      ...
      <section className="relative h-[400px] flex items-center justify-center text-white">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
            Commercial & Residential Roofing Contractor in Colleyville, TX
          </h1>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1C2A39] mb-8">
            Commercial and Residential Roofing Services in Colleyville
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            Ultra Roofing serves Colleyville, an upscale Tarrant County community located between Grapevine and North Richland Hills near Dallas-Fort Worth International Airport. Colleyville is home to high-value residential properties and premium commercial properties, including corporate offices, hospitality facilities, and retail establishments catering to affluent residents and airport-area businesses. We serve commercial property owners, building managers, and homeowners throughout Colleyville with TPO roofing, EPDM systems, metal roofing, storm damage repair, hail damage inspection, and complete insurance claim assistance.
          </p>
          <p className="text-lg text-gray-700 mb-8">
            Colleyville's proximity to DFW International Airport places the area on the flight path where properties are exposed to hail, wind shear, and severe thunderstorms. The area's high-value residential and commercial properties demand premium roofing solutions and expert restoration services. Our team understands the specific requirements of Colleyville property owners—from upscale residential roofing projects requiring aesthetic precision to commercial properties where operational continuity is critical. We have extensive experience with hail damage claims in the Colleyville area and work closely with insurance adjusters to maximize coverage on high-value properties.
          </p>

          <div className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1C2A39] mb-8 text-center">
              Our Roofing Services in Colleyville
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#F5F5F5] p-6 rounded-lg">
                ...
                <p className="text-gray-700">TPO single-ply membranes, EPDM rubber systems, metal roofing, modified bitumen, and roof coatings for retail, office, hospitality, and corporate properties.</p>
              </div>
              <div className="bg-[#F5F5F5] p-6 rounded-lg">
              ...
              <div className="bg-[#F5F5F5] p-6 rounded-lg">
                ...
                <p className="text-gray-700">Asphalt shingle replacement, metal roofing, tile roofing, and expert repair services using premium materials designed for Texas weather and upscale aesthetics.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1C2A39] text-white p-8 sm:p-12 rounded-lg">
            <h2 className="text-3xl sm:text-4xl font-bold mb-8">
              Why Choose Ultra Roofing in Colleyville?
            </h2>
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                <CheckCircle className="h-6 w-6 text-[#FFC107] mr-3 flex-shrink-0 mt-1" />
                <span className="text-lg">Serves all of Colleyville and surrounding Tarrant County areas</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-6 w-6 text-[#FFC107] mr-3 flex-shrink-0 mt-1" />
                <span className="text-lg">Free post-storm commercial and residential inspections across Colleyville</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-6 w-6 text-[#FFC107] mr-3 flex-shrink-0 mt-1" />
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-[#FFC107]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1C2A39] mb-6">
            Free Roof Inspection in Colleyville, TX
          </h2>
