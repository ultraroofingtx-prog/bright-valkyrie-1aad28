      ...
      <section className="relative h-[400px] flex items-center justify-center text-white">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
            Commercial & Residential Roofing Contractor in Grand Prairie, TX
          </h1>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1C2A39] mb-8">
            Commercial and Residential Roofing Services in Grand Prairie
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            Ultra Roofing serves Grand Prairie, a city of 200,000+ residents located between Dallas and Fort Worth, home to major industrial and commercial corridors along Interstate 30 and State Highway 360. Grand Prairie's diverse commercial landscape—from retail centers and distribution facilities to office parks—demands roofing solutions built for North Texas weather and high-traffic industrial areas. We serve commercial property owners, building managers, and homeowners throughout Grand Prairie with TPO roofing, EPDM systems, metal roofing, storm damage repair, hail damage inspection, and complete insurance claim assistance.
          </p>
          <p className="text-lg text-gray-700 mb-8">
            Grand Prairie's position in the central DFW metroplex exposes both commercial and residential properties to severe hail storms, wind events, and intense summer heat. Our team has inspected hundreds of Grand Prairie roofs damaged by spring hail and summer storms, working directly with local insurance adjusters to maximize coverage and ensure full restoration. We understand the specific challenges Grand Prairie property owners face—from industrial park roofs handling heavy weather exposure to residential neighborhoods requiring reliable storm damage response.
          </p>

          <div className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1C2A39] mb-8 text-center">
              Our Roofing Services in Grand Prairie
            </h2>
          ...
          <div className="bg-[#1C2A39] text-white p-8 sm:p-12 rounded-lg">
            <h2 className="text-3xl sm:text-4xl font-bold mb-8">
              Why Choose Ultra Roofing in Grand Prairie?
            </h2>
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                <CheckCircle className="h-6 w-6 text-[#FFC107] mr-3 flex-shrink-0 mt-1" />
                <span className="text-lg">Serves all of Grand Prairie and surrounding Dallas and Tarrant counties</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-6 w-6 text-[#FFC107] mr-3 flex-shrink-0 mt-1" />
                <span className="text-lg">Free post-storm commercial and residential inspections across Grand Prairie</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-6 w-6 text-[#FFC107] mr-3 flex-shrink-0 mt-1" />
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-[#FFC107]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1C2A39] mb-6">
            Free Roof Inspection in Grand Prairie, TX
          </h2>
